...
public abstract class BaseServlet extends HttpServlet implements Servlet {
    ...
    protected final String[] getRequestParameterValuesArray(String name){
        if (requestParameters == null){
            throw new RuntimeException("servlet.UsersServlet::getRequestParameterValuesArray: requestParameters не инициализирован. Вызовите метод getRequestParameters перед получением параметра!");
        }
