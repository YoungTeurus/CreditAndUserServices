...
public class StatementConstructor {
    ...
    public static String constructSelectSQLQuery(String tableName, List<Parameter> parameters){
    ...
    public static String constructInsertSQLQuery(String tableName, List<Parameter> parameters){
        StringBuilder sql = new StringBuilder();
        // Составляем sql запрос по типу:
